...
X_train.reshape(X_train.shape[0], X_train.shape[1], 1, 1, 1, 1, 1, 1, 1, 1)
X_validation.reshape(X_validation.shape[0], X_validation.shape[1], 1, 1, 1, 1, 1, 1, 1, 1)
X_test.reshape(X_test.shape[0], X_test.shape[1], 1, 1, 1, 1, 1, 1, 1, 1)
